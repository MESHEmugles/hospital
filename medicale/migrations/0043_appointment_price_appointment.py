...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('medicale', '0042_remove_appointment_price_appointment_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medicale.appointment_price')),
            ],
            options={
